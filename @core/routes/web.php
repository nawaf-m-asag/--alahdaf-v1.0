...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'HtmlMinifier']], function () {
    ...
    Route::post('/pdf/generate-invoice', 'FrontendController@generate_package_invoice')->name('frontend.package.invoice.generate');
    Route::get('/products/file/download/{id}', 'FrontendController@download_file')->name('products.file.download');
    //static page
    ...
    ---------------------------------------*/
        ...
        Route::get($blog_page_slug.'/json', 'FrontendController@blog_json')->name('frontend.blog.json');
    ...
    Route::get('last-news/json', 'FrontendController@last_news_json')->name('frontend.last_news.json');
...
Route::prefix('user-home')->middleware(['userEmailVerify', 'setlang:frontend', 'globalVariable', 'maintains_mode'])->group(function () {
    ...
    Route::get('/blogs/new', 'UserDashboardController@blogs_new')->name('user.home.blog.new');
    Route::post('/blogs/new', 'UserDashboardController@blogs_new_post')->name('user.home.blog.new');
...
Route::prefix('admin-home')->middleware(['setlang:backend'])->group(function () {
    ...
    Route::prefix('about-page')->middleware(['adminPermissionCheck:About Page Manage'])->group(function () {
        ...
        Route::get('/e-portal', 'AboutPageController@get_portal_page')->name('admin.e-portal.page');
        Route::post('/e-portal', 'AboutPageController@portal_update_page');
        /*------------------
        /*------------------
            GLOBAL NETWORK
        ------------------*/
