    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">مكتبة التحميلات</h5>
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="upload_media_image" data-toggle="tab" href="#upload_files" role="tab" aria-selected="true">رفع ملف</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link"  data-toggle="tab" href="#media_library" role="tab" id="load_all_media_images" aria-controls="media_library" aria-selected="false">مكتبة الوسائط</a>
                    </li>
                </ul>
                        ...
                        <div class="all-uploaded-images">
                            ...
                            <div class="main-content-area-wrap">
                               ...
                               <div class="image-list-wr5apper">
                                   ...
                                   <div id="loadmorewrap"><button type="button">عرض المزيد</button></div>
                               </div>
                                <div class="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                        ...
                                        <ul class="img-meta" style="display: none">
                                            ...
                                            <li class="imgalt">
                                               <div class="img-alt-wrap">
                                                   <input type="text" name="img_alt_tag" placeholder="العنوان ">
                                        ...
                                        <a tabindex="0" style="display: none" class=" btn btn-lg btn-danger btn-sm mb-3 mr-1" role="button" data-placement="right"  data-toggle="popover" data-trigger="focus" data-html="true" title="" data-content="
                                                       <h6>هل تريد الحذف</h6>
                                                       <br>
                                                        <input type='submit' class='btn btn-danger btn-sm media_library_image_delete_btn' value='نعم '>
                                                        </form>
                                                        " data-original-title="">
                                            <i class="ti-trash"></i>
                                        </a>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary media_upload_modal_submit_btn" style="display: none">تعيين الصورة</button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/alahdaf/public_html/@core/resources/views/backend/partials/media-upload/media-upload-markup.blade.php ENDPATH**/ ?>