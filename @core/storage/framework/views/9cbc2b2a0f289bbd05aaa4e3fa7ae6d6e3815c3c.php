                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            <h4 class="header-title">تحرير قائمة</h4>
                            <div class="btn-wrapper">
                                <a href="<?php echo e(route('admin.menu')); ?>" class="btn btn-primary btn-xs">القوائم</a>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="menu-left-side-content">
                                        <h3 class="title">اضافة عنصر الى القائمة</h3>
                                        <div class="accordion accordion-wrapper" id="add_menu_item_accordion">
                                                ...
                                                <div id="page-list-items-content" class="collapse show"
                                                    ...
                                                    <div class="card-body">
                                                        <ul class="page-list-ul">
                                                            <li data-ptype="custom" data-purl="@url" data-pname="الرئيسية">
                                                        ...
                                                        <div class="form-group">
                                                            <button type="button" id="add_page_to_menu"
                                                                    class="btn btn-primary btn-xs mt-4 pr-4 pl-4 add_page_to_menu">اضافة الى القائمة</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="custom-links-content" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="custom_url"><strong>الرابط</strong></label>
                                                            <input type="text" name="custom_url" id="custom_url"
                                                                   class="form-control"
                                                                   placeholder="<?php echo e(__('https://')); ?>">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="custom_label_text"><strong>نص الرابط</strong></label>
                                                        ...
                                                        <div class="form-group">
                                                            <button type="button" id="add_custom_links"
                                                                    class="btn btn-primary btn-xs mt-4 pr-4 pl-4">اضافة الى القائمة</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                   ...
                                   <div class="menu-structure-wrapper">
                                       <div class="card">
                                           <div class="card-header">
                                               <h3 class="title">هيكلية القائمة</h3>
                                           </div>
                                           <div class="card-body">
                                               <section id="drop_down_menu_builder_wrapper">
                                                   <div class="dd" id="nestable">
                                                       <ol class="dd-list">
                                                           ...
                                                           <?php else: ?>
                                                               <li class="dd-item" data-id="1" data-purl="@url" data-pname="الرئيسية" data-ptype="custom">
                                                                   <div class="dd-handle">
                                                                       الرئيسية
                                                                   </div>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" id="menu_structure_submit_btn" class="btn btn-primary mt-4 pr-4 pl-4">تحديث</button>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alahdaf/public_html/@core/resources/views/backend/pages/menu/menu-edit.blade.php ENDPATH**/ ?>