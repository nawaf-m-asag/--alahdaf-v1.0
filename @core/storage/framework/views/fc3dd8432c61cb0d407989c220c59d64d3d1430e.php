    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">بوابة العملاء</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.service.category')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="icon_type">الايقونة</label>
                                <select name="icon_type" class="form-control" id="icon_type">
                                    <option value="icon">ايقونة</option>
                ...
                <form action="<?php echo e(route('admin.service.category.update')); ?>"  method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  id="edit_name" name="name" placeholder="الاسم">
                        </div>
                        <div class="form-group">
                            <label for="edit_icon_type">الايقونة</label>
                        ...
                        <div class="form-group icon">
                            <label for="edit_icon" class="d-block">الايقونة</label>
                            <div class="btn-group ">
                                <button type="button" class="btn btn-primary iconpicker-component">
                                    <i class="fas fa-exclamation-triangle"></i>
                                </button>
                        ...
                        <div class="form-group">
                            <label for="edit_img_icon">الصورة</label>
                            <div class="media-upload-btn-wrapper">
                                <div class="img-wrap"></div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alahdaf/public_html/@core/resources/views/backend/pages/service/category.blade.php ENDPATH**/ ?>