...
<footer class="footer 
        ...
        <div class="text-center footer__socialmedia bg-gradient">
            ...
            ?>
            <?php $__currentLoopData = $all_social_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="text-decoration-none m-3 h1 text-white" href="<?php echo e($item->url); ?>"><i class="<?php echo e($item->icon); ?> py-3 footer__socialmedia--icon"></i></a>  
...
$(document).ready(function(){
    ...
    $("#blog_btn").on("click", function(){
            ...
            }).done(function(){ $("#blog_btn").html(`<?php echo e(get_static_option('var_'.$user_select_lang_slug.'_more')); ?>`)});  
     ...
     $("#last_news_btn").on("click", function(){
        ...
        $("#last_news_btn").html(`<div id="spinner" class="text-center">
          ...
          var offset=$('.last_news-item').length;
                ...
                }).done(function(){ $("#last_news_btn").html(`<?php echo e(get_static_option('var_'.$user_select_lang_slug.'_more')); ?>`)});  ;    
   });
...
<?php /**PATH /home/alahdaf/public_html/@core/resources/views/frontend/partials/footer.blade.php ENDPATH**/ ?>