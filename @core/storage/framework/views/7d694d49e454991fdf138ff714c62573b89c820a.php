            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-sm-4 clearfix">
                    <ul class="notification-area pull-right">
                        ...
                        <li><a class="btn btn-primary" target="_blank" href="<?php echo e(url('/')); ?>">عرض الموقع</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="breadcrumbs pull-left">
                            <li><a href="<?php echo e(route('admin.home')); ?>">الرئيسية</a></li>
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="<?php echo e(route('admin.profile.update')); ?>">تحرير الملف الشخصي</a>
                            <a class="dropdown-item" href="<?php echo e(route('admin.password.change')); ?>">تغيير كلمة المرور</a>
        ...
        $(document).ready(function ($) {
            ...
            $(document).on('click','.swal_delete_button',function(e){
              e.preventDefault();
                Swal.fire({
                  title: 'هل انت متاكد',
                  text: 'سوف يتم حذف العنصر حذف نهائي',
                  icon: 'warning',
...
<?php /**PATH /home/alahdaf/public_html/@core/resources/views/backend/admin-master.blade.php ENDPATH**/ ?>