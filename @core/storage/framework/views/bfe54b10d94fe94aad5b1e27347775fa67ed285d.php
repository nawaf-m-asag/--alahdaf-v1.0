...
<div class="row">
    <div class="right-side col-sm-12 col-md-8 bg-white px-0">
        ...
        <ul class="nav nav-tabs"
            ...
            <li class="nav-item"
                ...
                <button class="tabId nav-link h3 active"
                    ...
                    aria-selected="true"><?php echo e(get_static_option('var_'.$user_select_lang_slug.'_all')); ?></button>
            </li>
        ...
        <button  class="tabId nav-link h3"
            onclick="blog_ajax(<?php echo e($data->id); ?>)"
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-3 my-4">
                            <h3 class="text-center text-md-end text-muted fw-bolder"><?php echo e(get_static_option('blog_page_'.$user_select_lang_slug.'_name')); ?></h3>
                        </div>
                        <div class="col-9 my-4">
                            <div class="search-box">
                               <form action="<?php echo e(route('frontend.blog.search')); ?>" method="get"> 
    ...
    <div class="left-side col-sm-12  col-md-4 d-none d-md-block">
        <div class=" col-sm-12 col-md-11 bg-white">
            <div class="container pb-4">
                <h1 class="d-inline-block mb-5 mt-4"><?php echo e(get_static_option('var_'.$user_select_lang_slug.'_videos')); ?></h1>
                ...
                <div class="card mb-3"
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-8 card-body">
                            ...
                            <p class="card-text"><small class="text-muted"><?php echo e(__('Last updated')); ?> <?php
...
function blog_ajax(cat ) {
        var offset=$('.blog-item-'+cat).length;
                $.ajax({
                type: "GET",
                 url: "<?php echo e(route('frontend.blog.json')); ?>",
                cache: false,               
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/alahdaf/public_html/@core/resources/views/frontend/pages/blog/blog.blade.php ENDPATH**/ ?>