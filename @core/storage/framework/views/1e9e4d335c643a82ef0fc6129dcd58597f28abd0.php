        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner">
                    ...
                    <ul class="page-list">
                        <li><a href="<?php echo e(url('/')); ?>"><?php echo e(get_static_option('var_'.$user_select_lang_slug.'_home')); ?>/</a></li>
                        <?php
...
<?php /**PATH /home/alahdaf/public_html/@core/resources/views/frontend/partials/breadcrumb.blade.php ENDPATH**/ ?>