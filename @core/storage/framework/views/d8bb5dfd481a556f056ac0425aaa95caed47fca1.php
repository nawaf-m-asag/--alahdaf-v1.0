...
<div class="form-group">
    ...
    <div class="media-upload-btn-wrapper">
        ...
        <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="تحديد" data-modaltitle="رفع صورة" data-imgid="<?php echo e($id ?? ''); ?>" data-toggle="modal" data-target="#media_upload_modal">
            <?php echo e(__($signature_image_upload_btn_label)); ?>

        </button>
    </div>
    <small> <?php echo e($dimentions ?? ''); ?></small>
</div><?php /**PATH /home/alahdaf/public_html/@core/resources/views/components/media-upload.blade.php ENDPATH**/ ?>