...
class TestimonialController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->back()->with(['msg' => __('تم اضافة السلايدر بنجاح'),'type' => 'success']);
    }
    ...
    public function update(Request $request){
        ...
        return redirect()->back()->with(['msg' => __('تم تحديث السلايدر بنجاح'),'type' => 'success']);
    }
    public function clone(Request $request){
        ...
        return redirect()->back()->with(['msg' => __('تم نسخ السلايدر بنجاح'),'type' => 'success']);
    }

    public function delete(Request $request,$id){

        $testimonial = Testimonial::find($id)->delete();
        return redirect()->back()->with(['msg' => __('تم حذف السلايدر بنجاح'),'type' => 'danger']);
    }
