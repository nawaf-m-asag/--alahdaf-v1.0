...
class ForumController extends Controller
{
    ...
    public function index(){
        $all_blog = Forum::all()->groupBy('lang');
        return view('backend.pages.forum.index')->with([
            'all_blog' => $all_blog
        ]);
    }
    public function new_blog(){
        ...
        return view('backend.pages.forum.new')->with([
    ...
    public function store_new_blog(Request $request){
        ...
        $slug_check = Forum::where(['slug' => $slug,'lang' => $request->lang])->count();
    ...
    {
        $blog_details = Forum::find($request->item_id);
        Forum::create([
    ...
    public function edit_blog($id){
        $blog_post = Forum::find($id);
        $all_category = BlogCategory::where('lang',$blog_post->lang)->get();
        $all_language = Language::all();
        return view('backend.pages.forum.edit')->with([
            'all_category' => $all_category,
            'blog_post' => $blog_post,
            'all_languages' => $all_language,
        ]);
    ...
    public function category(){
        ...
        $all_language = Language::all();
        return view('backend.pages.forum.category')->with([
            'all_category' => $all_category,
            'all_languages' => $all_language
        ]);
    }
    ...
    public function delete_category(Request $request,$id){
        if (Forum::where('blog_categories_id',$id)->first()){
            return redirect()->back()->with([
    ...
    public function blog_page_settings(){
        ...
        return view('backend.pages.forum.page-settings.forum')->with(['all_languages' => $all_languages]);
    }
    public function blog_single_page_settings(){
        $all_languages = Language::all();
        return view('backend.pages.forum.page-settings.forum-single')->with(['all_languages' => $all_languages]);
    }
    ...
    public function bulk_action(Request $request){
        Forum::whereIn('id',$request->ids)->delete();
