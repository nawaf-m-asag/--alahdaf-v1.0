...
class FrontendUserManageController extends Controller
{
    ...
    public function user_password_change(Request $request)
    {
        ...
        $user->save();
        return redirect()->back()->with(['msg' => __('تم تحديث كلمة المرور'), 'type' => 'success']);
    }
    ...
    public function user_update(Request $request)
    {
        ...
        return redirect()->back()->with(['msg' => __('تم تحديث معلومات المستخدم'), 'type' => 'success']);
    }
    ...
    public function new_user_delete(Request $request, $id)
    {
        ...
        return redirect()->back()->with(['msg' => __('تم حذف مستخدم'), 'type' => 'danger']);
    }
    ...
    public function new_user_add(Request $request)
    {
        ...
        return redirect()->back()->with(['msg' => __('تم اضافة مستخدم'), 'type' => 'success']);
    }
    ...
    public function email_status(Request $request){
        ...
        return redirect()->back()->with(['msg' => __('تم تغيير حالة التحقق من البريد الالكتروني'), 'type' => 'success']);
    }
}
