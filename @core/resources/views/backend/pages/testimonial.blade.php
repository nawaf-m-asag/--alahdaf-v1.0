    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">السلايدر</h4>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.testimonial')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="name"  name="name" placeholder="ادخل العنوان">
                            </div>
                           
                            <div class="form-group">
                                <label for="description">الوصف</label>
                                <textarea class="form-control"  id="description"  name="description" placeholder="ادخل الوصف" cols="30" rows="10"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="status">اللغة</label>
                            ...
                            <div class="form-group">
                                ...
                                <small>يوصى باستخدام صورة 360x360 بكسل</small>
                            </div>
            ...
            <div class="modal-content">
                ...
                <form action="#" id="testimonial_edit_modal_form"  method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_name">العنوان</label>
                            <input type="text" class="form-control"  id="edit_name"  name="name" placeholder="ادخل العنوان">
                        </div>
                        
                        <div class="form-group">
                            <label for="edit_description">الوصف</label>
                            <textarea class="form-control"  id="edit_description"  name="description" placeholder="ادخل الوصف" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <small>يوصى باستخدام صورة :360*360 بكسل</small>
                        </div>
                    </div>
