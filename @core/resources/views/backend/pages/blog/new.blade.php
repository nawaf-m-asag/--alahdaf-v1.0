                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">اضافة مقالة جديدة</h4>
                            <a href="{{route('admin.blog')}}" class="btn btn-primary">كل المقالات</a>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="form-group">
                                        ...
                                        <select name="lang" id="language" class="form-control">
                                            <option value="">تحديد اللغة</option>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="info-text">حدد اللغة للحصول على  التصنيفات </span>
                                    </div>
                                    <div class="form-group">
