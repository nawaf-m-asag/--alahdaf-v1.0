                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.last-news.page.settings')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" >
                                    <div class="form-group">
                                        <label for="blog_page_{{$lang->slug}}_read_more_btn_text">نص قراءة المزيد</label>
                            ...
                            <div class="form-group">
                                <label for="blog_page_item">عدد الاخبار المعروضة</label>
                                <input type="text" class="form-control"  id="blog_page_item" value="{{get_static_option('blog_page_item')}}" name="blog_page_item" placeholder="عدد الاخبار">
                                <small class="text-danger">ادخل عدد الاخبار التي تريد عرضها في صفحة الاخبار</small>
                            </div>
