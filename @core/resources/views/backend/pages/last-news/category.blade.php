                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.last-news.category')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  id="name" name="name" placeholder="ادخل اسم التصنيف">
                            </div>
                            <div class="form-group">
                ...
                <form action="{{route('admin.last-news.category.update')}}"  method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control"  id="edit_name" name="name" placeholder="ادخل اسم التصنيف">
                        </div>
                        <div class="form-group">
