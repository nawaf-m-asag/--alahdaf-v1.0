                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.about.global.network')}}" method="post" enctype="multipart/form-data">
                                ...
                                @foreach($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="form-group">
                                            <label for="about_page_{{$lang}}_global_network_title">العنوان</label>
                                        ...
                                        <div class="form-group">
                                            <label for="about_page_{{$lang->slug}}_global_network_description">الوصف</label>
                            ...
                            <div class="form-group">
                                <label for="about_page_image_one">الصورة</label>
                                ...
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="تحديد" data-modaltitle="رفع الصورة" data-imgid="{{get_static_option('about_page_global_network_image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                        رفع الصورة
                                    </button>
                                </div>
                                <small>حجم الصورة الموصى به هو 650x380 بكسل</small>
                            </div>
