    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">من نحن</h4>
                        ...
                        <form action="{{route('admin.about.page.about')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content margin-top-30" id="nav-tabContent">
                                @foreach($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" aria-labelledby="nav-home-tab">
                                        ...
                                        <div class="form-group">
                                            <label for="about_page_{{$lang->slug}}_about_section_description">الوصف</label>
                                        ...
                                        <div class="form-group">
                                            <label for="about_page_{{$lang->slug}}_about_section_quote_text">نص اضافي</label>
                            ...
                            <div class="form-group">
                                <label for="about_page_image_one">الصورة لليسار</label>
                                ...
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="تحديد" data-modaltitle="رفع صورة" data-imgid="{{get_static_option('about_page_image_one')}}" data-toggle="modal" data-target="#media_upload_modal">
                                        رفع صورة
                                    </button>
                                </div>
                            ...
                            <div class="form-group">
                                <label for="about_page_image_two">الصورة لليمين</label>
                                @php $signature_image_upload_btn_label = 'Upload Image'; @endphp
                                <div class="media-upload-btn-wrapper">
                                    <div class="img-wrap">
                                        @php
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="تحديد" data-modaltitle="رفع صورة" data-imgid="{{get_static_option('about_page_image_two')}}" data-toggle="modal" data-target="#media_upload_modal">
                                        رفع صورة
                                    </button>
                                </div>
                                <small>حجم الصورة الموصى به هو 360x480 بكسل</small>
