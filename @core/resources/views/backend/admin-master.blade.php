            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-sm-4 clearfix">
                    <ul class="notification-area pull-right">
                        ...
                        <li><a class="btn btn-primary" target="_blank" href="{{url('/')}}">عرض الموقع</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        ...
                        <ul class="breadcrumbs pull-left">
                            <li><a href="{{route('admin.home')}}">الرئيسية</a></li>
                ...
                <div class="col-sm-6 clearfix">
                    <div class="user-profile pull-right">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('admin.profile.update')}}">تحرير الملف الشخصي</a>
                            <a class="dropdown-item" href="{{route('admin.password.change')}}">تغيير كلمة المرور</a>
