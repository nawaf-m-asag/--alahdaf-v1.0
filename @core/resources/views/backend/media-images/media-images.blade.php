                ...
                <div class="card">
                    <div class="card-body">
                        <div class="media-image-header">
                            <h2>مكتبة الوسائط</h2>
                            <a href="#" class="btn btn-info" data-toggle="modal" data-target="#media_image_upload_modal">اضافة صورة</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    <div class="alert alert-warning">{{__('أعد تحميل الصفحة لمشاهدة أحدث الصور التي تم تحميلها')}}</div>
