                            ...
                            <div class="card">
                                <div class="card-body">
                                   ...
                                   <div class="header-wrap d-flex justify-content-between">
                                      <div class="left-wrap">
                                          <h4 class="header-title">الطلبات</h4>
                                       ...
                                       <div class="righ-wrap">
                                           <a href="{{route('admin.product.order.new')}}" class="btn btn-primary">انشاء طلب</a>
                                       </div>
                                   </div>
                                            ...
                                            @foreach($all_orders as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                       ...
                                                       <h6>هل تريد الموافقة على هذا الطلب</h6>
                                                       <form method='post' action='{{route('admin.products.order.payment.approve',$data->id)}}'>
                                                       <input type='hidden' name='_token' value='{{csrf_token()}}'>
                                                       <br>
                                                        <input type='submit' class='btn btn-success btn-sm' value='نعم'>
                                                        </form>
                                                        " data-original-title="">
                                                                موافقة الدفع
                                                            </a>
                                                        ...
                                                        <form action="{{route('frontend.product.invoice.generate')}}"  method="post">
                                                            ...
                                                            <button class="btn btn-secondary" type="submit">الفاتورة</button>
                                                        </form>
                ...
                <div class="view-quote-details-info" id="view-quote-details-info">
                    ...
                    <div class="view-quote-top-wrap">
                        <div class="status-wrap">
                            الحالة <span class="quote-status-span"></span>
                        </div>
                        <div class="data-wrap">
                           التاريخ <span class="quote-date-span"></span>
                        </div>
                    </div>
