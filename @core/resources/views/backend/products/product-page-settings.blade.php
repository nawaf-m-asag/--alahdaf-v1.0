    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">اعداات صفحة المنتجات</h4>
                        <form action="{{route('admin.products.page.settings')}}" method="POST" enctype="multipart/form-data">
                                ...
                                @foreach($all_languages as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="nav-home-{{$lang->slug}}" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="form-group">
                                            <label for="product_category_{{$lang->slug}}_text">عنوان التصنيف</label>
                                        ...
                                        <div class="form-group">
                                            <label for="product_price_filter_{{$lang->slug}}_text">عنوان تصفية المنتجات</label>
                                        ...
                                        <div class="form-group">
                                            <label for="product_rating_filter_{{$lang->slug}}_text">عنوان التقييم</label>
                                        ...
                                        <div class="form-group">
                                            <label for="product_add_to_cart_button_{{$lang->slug}}_text">عنوان زر اضافة الئ السلة</label>
                            ...
                            <div class="form-group">
                                <label for="product_post_items">المنتجات</label>
