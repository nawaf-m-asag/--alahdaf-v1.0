                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="slug" name="slug" value="{{old('slug')}}" placeholder="ادخل العنوان للمتصفح">
                                    </div>
                                    ...
                                    <div class="form-group" style="display: none;">
                                        ...
                                        <span class="info-text">{{__(' الملفات المسموحة doc,docx,jpg,jpeg,png,mp3,mp4,pdf,txt,zip ')}}</span>
                                    </div>
                                    <div class="form-group">
