    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            <div class="col-12 mt-5">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">السكربتات</h4>
                        <form action="{{route('admin.general.scripts.settings')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="site_third_party_tracking_code">سوف يتم اضافة السكربت بداخل وسم الــ head</label>
                                ...
                                <p>سوف يتم اضافة هذا الكود قبل نهاية وسم الــ head</p>
                            </div>
                            <div class="form-group">
                                <label for="site_third_party_tracking_body_code">سوف يتم اضافة هذا السكربت بعد وسم الــ body</label>
                                ...
                                <p>سوف يتم تحميل هذا الكود بعد وسم الــ body</p>
                            </div>
                            <div class="form-group">
                                <label for="site_google_analytics">تحليلات جوجل</label>
                            ...
                            <div class="form-group">
                                <label for="site_google_captcha_status"><strong>تمكين Captcha</strong></label>
                                <label class="switch">
