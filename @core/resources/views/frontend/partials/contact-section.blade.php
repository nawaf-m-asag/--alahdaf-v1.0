            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title">
                        <h2 class="news__title pb-3 my-5 ">{{filter_static_option_value('home_page_01_'.$user_select_lang_slug.'_contact_area_title',$static_field_data)}}</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="btn-wrapper">
                            ...
                            class="btn"
                            name="signup_submit"
                            value="{{filter_static_option_value('home_page_01_'.$user_select_lang_slug.'_contact_area_button_text',$static_field_data)}}" />
